...
class TestOptim(TestCase):
    ...
    def _test_basic_cases(self, constructor, ignore_multidevice=False):
        ...
        self._test_basic_cases_template(
            ...
            torch.randn(10).cuda(),
            torch.randn(5).cuda(), constructor)
        # Multi-GPU
        ...
        self._test_basic_cases_template(
            ...
            torch.randn(5).cuda(0), constructor)
    ...
    def test_optimizer_1(self):
        self._test_basic_cases(lambda weight, bias: optim.Optimizer_1([weight, bias], lr=1e-3))
        self._test_basic_cases(
            lambda weight, bias: optim.Optimizer_1(
                self._build_params_dict(weight, bias, lr=1e-2),
                lr=1e-3)
        )
        self._test_basic_cases(lambda weight, bias: optim.Optimizer_1([weight, bias], lr=1e-3))
